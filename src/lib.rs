...
#[derive(Debug)]
pub struct CryptoLinkProcessor {
    verbose: bool,
    processed_count: usize,
}

impl CryptoLinkProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting CryptoLink processing");
    
    let mut processor = CryptoLinkProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = CryptoLinkProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = CryptoLinkProcessor::new(false);
